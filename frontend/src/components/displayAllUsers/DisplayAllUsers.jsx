...
const DisplayAllUsers = () => {
    ...
    return (
        <div>
            <Input type="text" name="search" placeholder="search" onChange={handleSearch} value={search} marginLeft="15px" width="500px" />
